...
//go:generate swagger generate server --target ../../app --name SolutionsEnabler9 --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/solutions-enabler9/build/templates --principal interface{}

func configureFlags(api *operations.SolutionsEnabler9API) {
...
func configureAPI(api *operations.SolutionsEnabler9API) http.Handler {
